This repo contains the project folder, a step-by-step guide and a (somewhat useful but ugly) infographic on how to set up the LSV cluster and how to submit jobs there using HTCondor.
